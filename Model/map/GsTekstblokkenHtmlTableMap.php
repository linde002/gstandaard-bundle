...
/**
 * This class defines the structure of the 'gs_tekstblokken_html' table.
 *
 *
 *
 ...
 */
class GsTekstblokkenHtmlTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.PharmaIntelligence.GstandaardBundle.Model.map.GsTekstblokkenHtmlTableMap';
    ...
    {
        // attributes
        $this->setName('gs_tekstblokken_html');
        $this->setPhpName('GsTekstblokkenHtml');
        $this->setClassname('PharmaIntelligence\\GstandaardBundle\\Model\\GsTekstblokkenHtml');
