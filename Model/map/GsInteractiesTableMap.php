...
/**
 * This class defines the structure of the 'gs_interacties' table.
 *
 *
 *
 ...
 */
class GsInteractiesTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.PharmaIntelligence.GstandaardBundle.Model.map.GsInteractiesTableMap';
    ...
    {
        // attributes
        $this->setName('gs_interacties');
        $this->setPhpName('GsInteracties');
        $this->setClassname('PharmaIntelligence\\GstandaardBundle\\Model\\GsInteracties');
