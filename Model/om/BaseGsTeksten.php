...
abstract class BaseGsTeksten extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PharmaIntelligence\\GstandaardBundle\\Model\\GsTekstenPeer';
     ...
     * @return GsTeksten The current object (for fluent API support)
     */
    public function setBestandnummer($v)
    {
        ...
        if ($this->bestandnummer !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstenPeer::BESTANDNUMMER;
        }
    ...
    public function setMutatiekode($v)
    {
        ...
        if ($this->mutatiekode !== $v) {
            $this->mutatiekode = $v;
            $this->modifiedColumns[] = GsTekstenPeer::MUTATIEKODE;
        }
    ...
    public function setTekstmodulethesaurus103($v)
    {
        ...
        if ($this->tekstmodulethesaurus_103 !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstenPeer::TEKSTMODULETHESAURUS_103;
        }
    ...
    public function setTekstmodule($v)
    {
        ...
        if ($this->tekstmodule !== $v) {
            $this->tekstmodule = $v;
            $this->modifiedColumns[] = GsTekstenPeer::TEKSTMODULE;
        }
    ...
    public function setTekstNivoKode($v)
    {
        ...
        if ($this->tekst_nivo_kode !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstenPeer::TEKST_NIVO_KODE;
        }
    ...
    public function setTekstsoortthesaurus104($v)
    {
        ...
        if ($this->tekstsoortthesaurus_104 !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstenPeer::TEKSTSOORTTHESAURUS_104;
        }
    ...
    public function setTekstsoort($v)
    {
        ...
        if ($this->tekstsoort !== $v) {
            $this->tekstsoort = $v;
            $this->modifiedColumns[] = GsTekstenPeer::TEKSTSOORT;
        }
    ...
    public function setTekstregelnummer($v)
    {
        ...
        if ($this->tekstregelnummer !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstenPeer::TEKSTREGELNUMMER;
        }
    ...
    public function setTekst($v)
    {
        ...
        if ($this->tekst !== $v) {
            $this->tekst = $v;
            $this->modifiedColumns[] = GsTekstenPeer::TEKST;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tekstmodulethesaurus_103 = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->tekstmodule = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->tekst_nivo_kode = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->tekstsoortthesaurus_104 = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->tekstsoort = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->tekstregelnummer = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->tekst = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->resetModified();
            ...
            return $startcol + 9; // 9 = GsTekstenPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GsTeksten object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GsTekstenPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GsTekstenQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GsTekstenPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GsTekstenPeer::BESTANDNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`bestandnummer`';
        }
        if ($this->isColumnModified(GsTekstenPeer::MUTATIEKODE)) {
            $modifiedColumns[':p' . $index++]  = '`mutatiekode`';
        }
        if ($this->isColumnModified(GsTekstenPeer::TEKSTMODULETHESAURUS_103)) {
            $modifiedColumns[':p' . $index++]  = '`tekstmodulethesaurus_103`';
        }
        if ($this->isColumnModified(GsTekstenPeer::TEKSTMODULE)) {
            $modifiedColumns[':p' . $index++]  = '`tekstmodule`';
        }
        if ($this->isColumnModified(GsTekstenPeer::TEKST_NIVO_KODE)) {
            $modifiedColumns[':p' . $index++]  = '`tekst_nivo_kode`';
        }
        if ($this->isColumnModified(GsTekstenPeer::TEKSTSOORTTHESAURUS_104)) {
            $modifiedColumns[':p' . $index++]  = '`tekstsoortthesaurus_104`';
        }
        if ($this->isColumnModified(GsTekstenPeer::TEKSTSOORT)) {
            $modifiedColumns[':p' . $index++]  = '`tekstsoort`';
        }
        if ($this->isColumnModified(GsTekstenPeer::TEKSTREGELNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`tekstregelnummer`';
        }
        if ($this->isColumnModified(GsTekstenPeer::TEKST)) {
            $modifiedColumns[':p' . $index++]  = '`tekst`';
        }

        $sql = sprintf(
            'INSERT INTO `gs_teksten` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GsTekstenPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GsTekstenPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GsTeksten'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GsTeksten'][serialize($this->getPrimaryKey())] = true;
        $keys = GsTekstenPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBestandnummer(),
            $keys[1] => $this->getMutatiekode(),
            $keys[2] => $this->getTekstmodulethesaurus103(),
            $keys[3] => $this->getTekstmodule(),
            $keys[4] => $this->getTekstNivoKode(),
            $keys[5] => $this->getTekstsoortthesaurus104(),
            $keys[6] => $this->getTekstsoort(),
            $keys[7] => $this->getTekstregelnummer(),
            $keys[8] => $this->getTekst(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setTekstmodulethesaurus103($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setTekstmodule($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setTekstNivoKode($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setTekstsoortthesaurus104($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setTekstsoort($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setTekstregelnummer($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setTekst($arr[$keys[8]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GsTekstenPeer::BESTANDNUMMER)) $criteria->add(GsTekstenPeer::BESTANDNUMMER, $this->bestandnummer);
        if ($this->isColumnModified(GsTekstenPeer::MUTATIEKODE)) $criteria->add(GsTekstenPeer::MUTATIEKODE, $this->mutatiekode);
        if ($this->isColumnModified(GsTekstenPeer::TEKSTMODULETHESAURUS_103)) $criteria->add(GsTekstenPeer::TEKSTMODULETHESAURUS_103, $this->tekstmodulethesaurus_103);
        if ($this->isColumnModified(GsTekstenPeer::TEKSTMODULE)) $criteria->add(GsTekstenPeer::TEKSTMODULE, $this->tekstmodule);
        if ($this->isColumnModified(GsTekstenPeer::TEKST_NIVO_KODE)) $criteria->add(GsTekstenPeer::TEKST_NIVO_KODE, $this->tekst_nivo_kode);
        if ($this->isColumnModified(GsTekstenPeer::TEKSTSOORTTHESAURUS_104)) $criteria->add(GsTekstenPeer::TEKSTSOORTTHESAURUS_104, $this->tekstsoortthesaurus_104);
        if ($this->isColumnModified(GsTekstenPeer::TEKSTSOORT)) $criteria->add(GsTekstenPeer::TEKSTSOORT, $this->tekstsoort);
        if ($this->isColumnModified(GsTekstenPeer::TEKSTREGELNUMMER)) $criteria->add(GsTekstenPeer::TEKSTREGELNUMMER, $this->tekstregelnummer);
        if ($this->isColumnModified(GsTekstenPeer::TEKST)) $criteria->add(GsTekstenPeer::TEKST, $this->tekst);
    ...
    {
        $criteria = new Criteria(GsTekstenPeer::DATABASE_NAME);
        $criteria->add(GsTekstenPeer::TEKSTMODULE, $this->tekstmodule);
        $criteria->add(GsTekstenPeer::TEKST_NIVO_KODE, $this->tekst_nivo_kode);
        $criteria->add(GsTekstenPeer::TEKSTSOORT, $this->tekstsoort);
        $criteria->add(GsTekstenPeer::TEKSTREGELNUMMER, $this->tekstregelnummer);
    ...
    public function getPrimaryKey()
    {
        ...
        $pks[1] = $this->getTekstNivoKode();
        $pks[2] = $this->getTekstsoort();
        $pks[3] = $this->getTekstregelnummer();
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setTekstNivoKode($keys[1]);
        $this->setTekstsoort($keys[2]);
        $this->setTekstregelnummer($keys[3]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getTekstmodule()) && (null === $this->getTekstNivoKode()) && (null === $this->getTekstsoort()) && (null === $this->getTekstregelnummer());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of GsTeksten (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GsTeksten Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GsTekstenPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GsTekstenPeer();
        }
    ...
    {
        return (string) $this->exportTo(GsTekstenPeer::DEFAULT_STRING_FORMAT);
    }
