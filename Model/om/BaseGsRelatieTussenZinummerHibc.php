...
abstract class BaseGsRelatieTussenZinummerHibc extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PharmaIntelligence\\GstandaardBundle\\Model\\GsRelatieTussenZinummerHibcPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GsRelatieTussenZinummerHibcPeer
     */
    ...
    /**
     * The value for the hibcbarcode field.
     * @var        string
     */
    protected $hibcbarcode;
    ...
    /**
     * Get the [hibcbarcode] column value.
     *
     * @return string
     */
     ...
     * @return GsRelatieTussenZinummerHibc The current object (for fluent API support)
     */
    public function setBestandnummer($v)
    {
        ...
        if ($this->bestandnummer !== $v) {
            ...
            $this->modifiedColumns[] = GsRelatieTussenZinummerHibcPeer::BESTANDNUMMER;
        }
    ...
    public function setMutatiekode($v)
    {
        ...
        if ($this->mutatiekode !== $v) {
            $this->mutatiekode = $v;
            $this->modifiedColumns[] = GsRelatieTussenZinummerHibcPeer::MUTATIEKODE;
        }
    ...
    public function setZinummer($v)
    {
        ...
        if ($this->zinummer !== $v) {
            $this->zinummer = $v;
            $this->modifiedColumns[] = GsRelatieTussenZinummerHibcPeer::ZINUMMER;
        }
    ...
    /**
     * Set the value of [hibcbarcode] column.
     *
    ...
    public function setHibcbarcode($v)
    {
        ...
        if ($this->hibcbarcode !== $v) {
            $this->hibcbarcode = $v;
            $this->modifiedColumns[] = GsRelatieTussenZinummerHibcPeer::HIBCBARCODE;
        }
    ...
    public function setHandelsproduktkode($v)
    {
        ...
        if ($this->handelsproduktkode !== $v) {
            ...
            $this->modifiedColumns[] = GsRelatieTussenZinummerHibcPeer::HANDELSPRODUKTKODE;
        }
    ...
    public function setIdentificatieNummer($v)
    {
        ...
        if ($this->identificatie_nummer !== $v) {
            ...
            $this->modifiedColumns[] = GsRelatieTussenZinummerHibcPeer::IDENTIFICATIE_NUMMER;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->hibcbarcode = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->handelsproduktkode = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->identificatie_nummer = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = GsRelatieTussenZinummerHibcPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GsRelatieTussenZinummerHibc object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GsRelatieTussenZinummerHibcPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GsRelatieTussenZinummerHibcQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GsRelatieTussenZinummerHibcPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::BESTANDNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`bestandnummer`';
        }
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::MUTATIEKODE)) {
            $modifiedColumns[':p' . $index++]  = '`mutatiekode`';
        }
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::ZINUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`zinummer`';
        }
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::HIBCBARCODE)) {
            $modifiedColumns[':p' . $index++]  = '`hibcbarcode`';
        }
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::HANDELSPRODUKTKODE)) {
            $modifiedColumns[':p' . $index++]  = '`handelsproduktkode`';
        }
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::IDENTIFICATIE_NUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`identificatie_nummer`';
        }

        $sql = sprintf(
            'INSERT INTO `gs_relatie_tussen_zinummer_hibc` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`zinummer`':
                        ...
                        break;
                    case '`hibcbarcode`':
                        $stmt->bindValue($identifier, $this->hibcbarcode, PDO::PARAM_STR);
                        break;
                    case '`handelsproduktkode`':
                        $stmt->bindValue($identifier, $this->handelsproduktkode, PDO::PARAM_STR);
                        break;
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GsRelatieTussenZinummerHibcPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GsRelatieTussenZinummerHibcPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GsRelatieTussenZinummerHibc'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GsRelatieTussenZinummerHibc'][$this->getPrimaryKey()] = true;
        $keys = GsRelatieTussenZinummerHibcPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBestandnummer(),
            $keys[1] => $this->getMutatiekode(),
            $keys[2] => $this->getZinummer(),
            $keys[3] => $this->getHibcbarcode(),
            $keys[4] => $this->getHandelsproduktkode(),
            $keys[5] => $this->getIdentificatieNummer(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setHibcbarcode($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setHandelsproduktkode($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setIdentificatieNummer($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::BESTANDNUMMER)) $criteria->add(GsRelatieTussenZinummerHibcPeer::BESTANDNUMMER, $this->bestandnummer);
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::MUTATIEKODE)) $criteria->add(GsRelatieTussenZinummerHibcPeer::MUTATIEKODE, $this->mutatiekode);
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::ZINUMMER)) $criteria->add(GsRelatieTussenZinummerHibcPeer::ZINUMMER, $this->zinummer);
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::HIBCBARCODE)) $criteria->add(GsRelatieTussenZinummerHibcPeer::HIBCBARCODE, $this->hibcbarcode);
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::HANDELSPRODUKTKODE)) $criteria->add(GsRelatieTussenZinummerHibcPeer::HANDELSPRODUKTKODE, $this->handelsproduktkode);
        if ($this->isColumnModified(GsRelatieTussenZinummerHibcPeer::IDENTIFICATIE_NUMMER)) $criteria->add(GsRelatieTussenZinummerHibcPeer::IDENTIFICATIE_NUMMER, $this->identificatie_nummer);
    ...
    {
        $criteria = new Criteria(GsRelatieTussenZinummerHibcPeer::DATABASE_NAME);
        $criteria->add(GsRelatieTussenZinummerHibcPeer::ZINUMMER, $this->zinummer);
     ...
     * objects.
     *
     * @param object $copyObj An object of GsRelatieTussenZinummerHibc (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GsRelatieTussenZinummerHibc Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GsRelatieTussenZinummerHibcPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GsRelatieTussenZinummerHibcPeer();
        }
    ...
    public function setGsArtikelen(GsArtikelen $v = null)
    {
        ...
        if ($v !== null) {
            $v->setGsRelatieTussenZinummerHibc($this);
        }
    ...
    public function getGsArtikelen(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aGsArtikelen === null && ($this->zinummer !== null) && $doQuery) {
            ...
            $this->aGsArtikelen->setGsRelatieTussenZinummerHibc($this);
        }
    ...
    {
        return (string) $this->exportTo(GsRelatieTussenZinummerHibcPeer::DEFAULT_STRING_FORMAT);
    }
