...
abstract class BaseGsInteracties extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PharmaIntelligence\\GstandaardBundle\\Model\\GsInteractiesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GsInteractiesPeer
     */
     ...
     * @return GsInteracties The current object (for fluent API support)
     */
    public function setBestandnummer($v)
    {
        ...
        if ($this->bestandnummer !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::BESTANDNUMMER;
        }
    ...
    public function setMutatiekode($v)
    {
        ...
        if ($this->mutatiekode !== $v) {
            $this->mutatiekode = $v;
            $this->modifiedColumns[] = GsInteractiesPeer::MUTATIEKODE;
        }
    ...
    public function setInteractiewaarschuwingCode($v)
    {
        ...
        if ($this->interactiewaarschuwing_code !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::INTERACTIEWAARSCHUWING_CODE;
        }
    ...
    public function setDatumVastlegging($v)
    {
        ...
        if ($this->datum_vastlegging !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::DATUM_VASTLEGGING;
        }
    ...
    public function setDatumOpnameInGstandaard($v)
    {
        ...
        if ($this->datum_opname_in_gstandaard !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::DATUM_OPNAME_IN_GSTANDAARD;
        }
    ...
    public function setDatumLaasteMutatieInGstandaard($v)
    {
        ...
        if ($this->datum_laaste_mutatie_in_gstandaard !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::DATUM_LAASTE_MUTATIE_IN_GSTANDAARD;
        }
    ...
    public function setCodeOnderbouwingBewijslastBijInteractie($v)
    {
        ...
        if ($this->code_onderbouwing_bewijslast_bij_interactie !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::CODE_ONDERBOUWING_BEWIJSLAST_BIJ_INTERACTIE;
        }
    ...
    public function setCodeErnstVanPotentieelEffectBijInteractie($v)
    {
        ...
        if ($this->code_ernst_van_potentieel_effect_bij_interactie !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::CODE_ERNST_VAN_POTENTIEEL_EFFECT_BIJ_INTERACTIE;
        }
    ...
    public function setOmschrijvingInteractiewaarschuwing($v)
    {
        ...
        if ($this->omschrijving_interactiewaarschuwing !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::OMSCHRIJVING_INTERACTIEWAARSCHUWING;
        }
    ...
    public function setInteractiefolderthesaurus128($v)
    {
        ...
        if ($this->interactiefolderthesaurus_128 !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::INTERACTIEFOLDERTHESAURUS_128;
        }
    ...
    public function setFolder($v)
    {
        ...
        if ($this->folder !== $v) {
            $this->folder = $v;
            $this->modifiedColumns[] = GsInteractiesPeer::FOLDER;
        }
    ...
    public function setInteractie($v)
    {
        ...
        if ($this->interactie !== $v) {
            $this->interactie = $v;
            $this->modifiedColumns[] = GsInteractiesPeer::INTERACTIE;
        }
    ...
    public function setVervolgActie($v)
    {
        ...
        if ($this->vervolg_actie !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::VERVOLG_ACTIE;
        }
    ...
    public function setIaTeVolgenDoorMonitoren($v)
    {
        ...
        if ($this->ia_te_volgen_door_monitoren !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::IA_TE_VOLGEN_DOOR_MONITOREN;
        }
    ...
    public function setOokBijStakenVanHetVoorschrift($v)
    {
        ...
        if ($this->ook_bij_staken_van_het_voorschrift !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::OOK_BIJ_STAKEN_VAN_HET_VOORSCHRIFT;
        }
    ...
    public function setAfhandelingVoorschrijver($v)
    {
        ...
        if ($this->afhandeling_voorschrijver !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::AFHANDELING_VOORSCHRIJVER;
        }
    ...
    public function setAfhandelingBalieInApotheek($v)
    {
        ...
        if ($this->afhandeling_balie_in_apotheek !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::AFHANDELING_BALIE_IN_APOTHEEK;
        }
    ...
    public function setAfhandelingFarmaceutischSpecialist($v)
    {
        ...
        if ($this->afhandeling_farmaceutisch_specialist !== $v) {
            ...
            $this->modifiedColumns[] = GsInteractiesPeer::AFHANDELING_FARMACEUTISCH_SPECIALIST;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 18; // 18 = GsInteractiesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GsInteracties object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GsInteractiesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GsInteractiesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GsInteractiesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GsInteractiesPeer::BESTANDNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`bestandnummer`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::MUTATIEKODE)) {
            $modifiedColumns[':p' . $index++]  = '`mutatiekode`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::INTERACTIEWAARSCHUWING_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`interactiewaarschuwing_code`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::DATUM_VASTLEGGING)) {
            $modifiedColumns[':p' . $index++]  = '`datum_vastlegging`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::DATUM_OPNAME_IN_GSTANDAARD)) {
            $modifiedColumns[':p' . $index++]  = '`datum_opname_in_gstandaard`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::DATUM_LAASTE_MUTATIE_IN_GSTANDAARD)) {
            $modifiedColumns[':p' . $index++]  = '`datum_laaste_mutatie_in_gstandaard`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::CODE_ONDERBOUWING_BEWIJSLAST_BIJ_INTERACTIE)) {
            $modifiedColumns[':p' . $index++]  = '`code_onderbouwing_bewijslast_bij_interactie`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::CODE_ERNST_VAN_POTENTIEEL_EFFECT_BIJ_INTERACTIE)) {
            $modifiedColumns[':p' . $index++]  = '`code_ernst_van_potentieel_effect_bij_interactie`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::OMSCHRIJVING_INTERACTIEWAARSCHUWING)) {
            $modifiedColumns[':p' . $index++]  = '`omschrijving_interactiewaarschuwing`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::INTERACTIEFOLDERTHESAURUS_128)) {
            $modifiedColumns[':p' . $index++]  = '`interactiefolderthesaurus_128`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::FOLDER)) {
            $modifiedColumns[':p' . $index++]  = '`folder`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::INTERACTIE)) {
            $modifiedColumns[':p' . $index++]  = '`interactie`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::VERVOLG_ACTIE)) {
            $modifiedColumns[':p' . $index++]  = '`vervolg_actie`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::IA_TE_VOLGEN_DOOR_MONITOREN)) {
            $modifiedColumns[':p' . $index++]  = '`ia_te_volgen_door_monitoren`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::OOK_BIJ_STAKEN_VAN_HET_VOORSCHRIFT)) {
            $modifiedColumns[':p' . $index++]  = '`ook_bij_staken_van_het_voorschrift`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::AFHANDELING_VOORSCHRIJVER)) {
            $modifiedColumns[':p' . $index++]  = '`afhandeling_voorschrijver`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::AFHANDELING_BALIE_IN_APOTHEEK)) {
            $modifiedColumns[':p' . $index++]  = '`afhandeling_balie_in_apotheek`';
        }
        if ($this->isColumnModified(GsInteractiesPeer::AFHANDELING_FARMACEUTISCH_SPECIALIST)) {
            $modifiedColumns[':p' . $index++]  = '`afhandeling_farmaceutisch_specialist`';
        }

        $sql = sprintf(
            'INSERT INTO `gs_interacties` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GsInteractiesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GsInteractiesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GsInteracties'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GsInteracties'][$this->getPrimaryKey()] = true;
        $keys = GsInteractiesPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GsInteractiesPeer::BESTANDNUMMER)) $criteria->add(GsInteractiesPeer::BESTANDNUMMER, $this->bestandnummer);
        if ($this->isColumnModified(GsInteractiesPeer::MUTATIEKODE)) $criteria->add(GsInteractiesPeer::MUTATIEKODE, $this->mutatiekode);
        if ($this->isColumnModified(GsInteractiesPeer::INTERACTIEWAARSCHUWING_CODE)) $criteria->add(GsInteractiesPeer::INTERACTIEWAARSCHUWING_CODE, $this->interactiewaarschuwing_code);
        if ($this->isColumnModified(GsInteractiesPeer::DATUM_VASTLEGGING)) $criteria->add(GsInteractiesPeer::DATUM_VASTLEGGING, $this->datum_vastlegging);
        if ($this->isColumnModified(GsInteractiesPeer::DATUM_OPNAME_IN_GSTANDAARD)) $criteria->add(GsInteractiesPeer::DATUM_OPNAME_IN_GSTANDAARD, $this->datum_opname_in_gstandaard);
        if ($this->isColumnModified(GsInteractiesPeer::DATUM_LAASTE_MUTATIE_IN_GSTANDAARD)) $criteria->add(GsInteractiesPeer::DATUM_LAASTE_MUTATIE_IN_GSTANDAARD, $this->datum_laaste_mutatie_in_gstandaard);
        if ($this->isColumnModified(GsInteractiesPeer::CODE_ONDERBOUWING_BEWIJSLAST_BIJ_INTERACTIE)) $criteria->add(GsInteractiesPeer::CODE_ONDERBOUWING_BEWIJSLAST_BIJ_INTERACTIE, $this->code_onderbouwing_bewijslast_bij_interactie);
        if ($this->isColumnModified(GsInteractiesPeer::CODE_ERNST_VAN_POTENTIEEL_EFFECT_BIJ_INTERACTIE)) $criteria->add(GsInteractiesPeer::CODE_ERNST_VAN_POTENTIEEL_EFFECT_BIJ_INTERACTIE, $this->code_ernst_van_potentieel_effect_bij_interactie);
        if ($this->isColumnModified(GsInteractiesPeer::OMSCHRIJVING_INTERACTIEWAARSCHUWING)) $criteria->add(GsInteractiesPeer::OMSCHRIJVING_INTERACTIEWAARSCHUWING, $this->omschrijving_interactiewaarschuwing);
        if ($this->isColumnModified(GsInteractiesPeer::INTERACTIEFOLDERTHESAURUS_128)) $criteria->add(GsInteractiesPeer::INTERACTIEFOLDERTHESAURUS_128, $this->interactiefolderthesaurus_128);
        if ($this->isColumnModified(GsInteractiesPeer::FOLDER)) $criteria->add(GsInteractiesPeer::FOLDER, $this->folder);
        if ($this->isColumnModified(GsInteractiesPeer::INTERACTIE)) $criteria->add(GsInteractiesPeer::INTERACTIE, $this->interactie);
        if ($this->isColumnModified(GsInteractiesPeer::VERVOLG_ACTIE)) $criteria->add(GsInteractiesPeer::VERVOLG_ACTIE, $this->vervolg_actie);
        if ($this->isColumnModified(GsInteractiesPeer::IA_TE_VOLGEN_DOOR_MONITOREN)) $criteria->add(GsInteractiesPeer::IA_TE_VOLGEN_DOOR_MONITOREN, $this->ia_te_volgen_door_monitoren);
        if ($this->isColumnModified(GsInteractiesPeer::OOK_BIJ_STAKEN_VAN_HET_VOORSCHRIFT)) $criteria->add(GsInteractiesPeer::OOK_BIJ_STAKEN_VAN_HET_VOORSCHRIFT, $this->ook_bij_staken_van_het_voorschrift);
        if ($this->isColumnModified(GsInteractiesPeer::AFHANDELING_VOORSCHRIJVER)) $criteria->add(GsInteractiesPeer::AFHANDELING_VOORSCHRIJVER, $this->afhandeling_voorschrijver);
        if ($this->isColumnModified(GsInteractiesPeer::AFHANDELING_BALIE_IN_APOTHEEK)) $criteria->add(GsInteractiesPeer::AFHANDELING_BALIE_IN_APOTHEEK, $this->afhandeling_balie_in_apotheek);
        if ($this->isColumnModified(GsInteractiesPeer::AFHANDELING_FARMACEUTISCH_SPECIALIST)) $criteria->add(GsInteractiesPeer::AFHANDELING_FARMACEUTISCH_SPECIALIST, $this->afhandeling_farmaceutisch_specialist);
    ...
    {
        $criteria = new Criteria(GsInteractiesPeer::DATABASE_NAME);
        $criteria->add(GsInteractiesPeer::INTERACTIEWAARSCHUWING_CODE, $this->interactiewaarschuwing_code);
     ...
     * objects.
     *
     * @param object $copyObj An object of GsInteracties (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GsInteracties Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GsInteractiesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GsInteractiesPeer();
        }
    ...
    {
        return (string) $this->exportTo(GsInteractiesPeer::DEFAULT_STRING_FORMAT);
    }
