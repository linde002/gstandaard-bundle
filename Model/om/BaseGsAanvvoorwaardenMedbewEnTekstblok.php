...
abstract class BaseGsAanvvoorwaardenMedbewEnTekstblok extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PharmaIntelligence\\GstandaardBundle\\Model\\GsAanvvoorwaardenMedbewEnTekstblokPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GsAanvvoorwaardenMedbewEnTekstblokPeer
     */
     ...
     * @return GsAanvvoorwaardenMedbewEnTekstblok The current object (for fluent API support)
     */
    public function setBestandnummer($v)
    {
        ...
        if ($this->bestandnummer !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::BESTANDNUMMER;
        }
    ...
    public function setMutatiekode($v)
    {
        ...
        if ($this->mutatiekode !== $v) {
            $this->mutatiekode = $v;
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::MUTATIEKODE;
        }
    ...
    public function setThesnrBewakingssoort($v)
    {
        ...
        if ($this->thesnr_bewakingssoort !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::THESNR_BEWAKINGSSOORT;
        }
    ...
    public function setBewakingssoort($v)
    {
        ...
        if ($this->bewakingssoort !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::BEWAKINGSSOORT;
        }
    ...
    public function setMedicatiebewakingIdentificerendeCode($v)
    {
        ...
        if ($this->medicatiebewaking_identificerende_code !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_IDENTIFICERENDE_CODE;
        }
    ...
    public function setThesaurusVerwijzingTekstmodule($v)
    {
        ...
        if ($this->thesaurus_verwijzing_tekstmodule !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUS_VERWIJZING_TEKSTMODULE;
        }
    ...
    public function setTekstmodule($v)
    {
        ...
        if ($this->tekstmodule !== $v) {
            $this->tekstmodule = $v;
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTMODULE;
        }
    ...
    public function setThesaurusVerwijzingTekstsoort($v)
    {
        ...
        if ($this->thesaurus_verwijzing_tekstsoort !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUS_VERWIJZING_TEKSTSOORT;
        }
    ...
    public function setTekstsoort($v)
    {
        ...
        if ($this->tekstsoort !== $v) {
            $this->tekstsoort = $v;
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTSOORT;
        }
    ...
    public function setTekstbloknummer($v)
    {
        ...
        if ($this->tekstbloknummer !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTBLOKNUMMER;
        }
    ...
    public function setThesaurusverwijzingAanvullendeVoorwaarde($v)
    {
        ...
        if ($this->thesaurusverwijzing_aanvullende_voorwaarde !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUSVERWIJZING_AANVULLENDE_VOORWAARDE;
        }
    ...
    public function setMedicatiebewakingAanvullendeVoorwaarde($v)
    {
        ...
        if ($this->medicatiebewaking_aanvullende_voorwaarde !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_AANVULLENDE_VOORWAARDE;
        }
    ...
    public function setCoderingWaarde1Alfanumeriek($v)
    {
        ...
        if ($this->codering_waarde_1_alfanumeriek !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_1_ALFANUMERIEK;
        }
    ...
    public function setCoderingWaarde2Numeriek($v)
    {
        ...
        if ($this->codering_waarde_2_numeriek !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_2_NUMERIEK;
        }
    ...
    public function setCoderingWaarde3Numeriek($v)
    {
        ...
        if ($this->codering_waarde_3_numeriek !== $v) {
            ...
            $this->modifiedColumns[] = GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_3_NUMERIEK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->thesaurus_verwijzing_tekstmodule = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->tekstmodule = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->thesaurus_verwijzing_tekstsoort = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->tekstsoort = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->tekstbloknummer = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            $this->thesaurusverwijzing_aanvullende_voorwaarde = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
            $this->medicatiebewaking_aanvullende_voorwaarde = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            $this->codering_waarde_1_alfanumeriek = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->codering_waarde_2_numeriek = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
            $this->codering_waarde_3_numeriek = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
            $this->resetModified();
            ...
            return $startcol + 15; // 15 = GsAanvvoorwaardenMedbewEnTekstblokPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GsAanvvoorwaardenMedbewEnTekstblok object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GsAanvvoorwaardenMedbewEnTekstblokPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GsAanvvoorwaardenMedbewEnTekstblokQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GsAanvvoorwaardenMedbewEnTekstblokPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::BESTANDNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`bestandnummer`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::MUTATIEKODE)) {
            $modifiedColumns[':p' . $index++]  = '`mutatiekode`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESNR_BEWAKINGSSOORT)) {
            $modifiedColumns[':p' . $index++]  = '`thesnr_bewakingssoort`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::BEWAKINGSSOORT)) {
            $modifiedColumns[':p' . $index++]  = '`bewakingssoort`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_IDENTIFICERENDE_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`medicatiebewaking_identificerende_code`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUS_VERWIJZING_TEKSTMODULE)) {
            $modifiedColumns[':p' . $index++]  = '`thesaurus_verwijzing_tekstmodule`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTMODULE)) {
            $modifiedColumns[':p' . $index++]  = '`tekstmodule`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUS_VERWIJZING_TEKSTSOORT)) {
            $modifiedColumns[':p' . $index++]  = '`thesaurus_verwijzing_tekstsoort`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTSOORT)) {
            $modifiedColumns[':p' . $index++]  = '`tekstsoort`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTBLOKNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`tekstbloknummer`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUSVERWIJZING_AANVULLENDE_VOORWAARDE)) {
            $modifiedColumns[':p' . $index++]  = '`thesaurusverwijzing_aanvullende_voorwaarde`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_AANVULLENDE_VOORWAARDE)) {
            $modifiedColumns[':p' . $index++]  = '`medicatiebewaking_aanvullende_voorwaarde`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_1_ALFANUMERIEK)) {
            $modifiedColumns[':p' . $index++]  = '`codering_waarde_1_alfanumeriek`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_2_NUMERIEK)) {
            $modifiedColumns[':p' . $index++]  = '`codering_waarde_2_numeriek`';
        }
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_3_NUMERIEK)) {
            $modifiedColumns[':p' . $index++]  = '`codering_waarde_3_numeriek`';
        }

        $sql = sprintf(
            'INSERT INTO `gs_aanvvoorwaarden_medbew_en_tekstblok` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GsAanvvoorwaardenMedbewEnTekstblokPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GsAanvvoorwaardenMedbewEnTekstblokPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GsAanvvoorwaardenMedbewEnTekstblok'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GsAanvvoorwaardenMedbewEnTekstblok'][serialize($this->getPrimaryKey())] = true;
        $keys = GsAanvvoorwaardenMedbewEnTekstblokPeer::getFieldNames($keyType);
        $result = array(
            ...
            $keys[5] => $this->getThesaurusVerwijzingTekstmodule(),
            $keys[6] => $this->getTekstmodule(),
            $keys[7] => $this->getThesaurusVerwijzingTekstsoort(),
            $keys[8] => $this->getTekstsoort(),
            $keys[9] => $this->getTekstbloknummer(),
            $keys[10] => $this->getThesaurusverwijzingAanvullendeVoorwaarde(),
            $keys[11] => $this->getMedicatiebewakingAanvullendeVoorwaarde(),
            $keys[12] => $this->getCoderingWaarde1Alfanumeriek(),
            $keys[13] => $this->getCoderingWaarde2Numeriek(),
            $keys[14] => $this->getCoderingWaarde3Numeriek(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setThesaurusVerwijzingTekstmodule($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setTekstmodule($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setThesaurusVerwijzingTekstsoort($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setTekstsoort($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setTekstbloknummer($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setThesaurusverwijzingAanvullendeVoorwaarde($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setMedicatiebewakingAanvullendeVoorwaarde($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setCoderingWaarde1Alfanumeriek($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setCoderingWaarde2Numeriek($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setCoderingWaarde3Numeriek($arr[$keys[14]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::BESTANDNUMMER)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::BESTANDNUMMER, $this->bestandnummer);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::MUTATIEKODE)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::MUTATIEKODE, $this->mutatiekode);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESNR_BEWAKINGSSOORT)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESNR_BEWAKINGSSOORT, $this->thesnr_bewakingssoort);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::BEWAKINGSSOORT)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::BEWAKINGSSOORT, $this->bewakingssoort);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_IDENTIFICERENDE_CODE)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_IDENTIFICERENDE_CODE, $this->medicatiebewaking_identificerende_code);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUS_VERWIJZING_TEKSTMODULE)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUS_VERWIJZING_TEKSTMODULE, $this->thesaurus_verwijzing_tekstmodule);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTMODULE)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTMODULE, $this->tekstmodule);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUS_VERWIJZING_TEKSTSOORT)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUS_VERWIJZING_TEKSTSOORT, $this->thesaurus_verwijzing_tekstsoort);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTSOORT)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTSOORT, $this->tekstsoort);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTBLOKNUMMER)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTBLOKNUMMER, $this->tekstbloknummer);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUSVERWIJZING_AANVULLENDE_VOORWAARDE)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::THESAURUSVERWIJZING_AANVULLENDE_VOORWAARDE, $this->thesaurusverwijzing_aanvullende_voorwaarde);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_AANVULLENDE_VOORWAARDE)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_AANVULLENDE_VOORWAARDE, $this->medicatiebewaking_aanvullende_voorwaarde);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_1_ALFANUMERIEK)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_1_ALFANUMERIEK, $this->codering_waarde_1_alfanumeriek);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_2_NUMERIEK)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_2_NUMERIEK, $this->codering_waarde_2_numeriek);
        if ($this->isColumnModified(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_3_NUMERIEK)) $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_3_NUMERIEK, $this->codering_waarde_3_numeriek);
    ...
    {
        $criteria = new Criteria(GsAanvvoorwaardenMedbewEnTekstblokPeer::DATABASE_NAME);
        $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::BEWAKINGSSOORT, $this->bewakingssoort);
        $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_IDENTIFICERENDE_CODE, $this->medicatiebewaking_identificerende_code);
        $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTMODULE, $this->tekstmodule);
        $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTSOORT, $this->tekstsoort);
        $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::TEKSTBLOKNUMMER, $this->tekstbloknummer);
        $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::MEDICATIEBEWAKING_AANVULLENDE_VOORWAARDE, $this->medicatiebewaking_aanvullende_voorwaarde);
        $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_1_ALFANUMERIEK, $this->codering_waarde_1_alfanumeriek);
        $criteria->add(GsAanvvoorwaardenMedbewEnTekstblokPeer::CODERING_WAARDE_2_NUMERIEK, $this->codering_waarde_2_numeriek);
    ...
    public function getPrimaryKey()
    {
        ...
        $pks[2] = $this->getTekstmodule();
        $pks[3] = $this->getTekstsoort();
        $pks[4] = $this->getTekstbloknummer();
        $pks[5] = $this->getMedicatiebewakingAanvullendeVoorwaarde();
        $pks[6] = $this->getCoderingWaarde1Alfanumeriek();
        $pks[7] = $this->getCoderingWaarde2Numeriek();
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setTekstmodule($keys[2]);
        $this->setTekstsoort($keys[3]);
        $this->setTekstbloknummer($keys[4]);
        $this->setMedicatiebewakingAanvullendeVoorwaarde($keys[5]);
        $this->setCoderingWaarde1Alfanumeriek($keys[6]);
        $this->setCoderingWaarde2Numeriek($keys[7]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getBewakingssoort()) && (null === $this->getMedicatiebewakingIdentificerendeCode()) && (null === $this->getTekstmodule()) && (null === $this->getTekstsoort()) && (null === $this->getTekstbloknummer()) && (null === $this->getMedicatiebewakingAanvullendeVoorwaarde()) && (null === $this->getCoderingWaarde1Alfanumeriek()) && (null === $this->getCoderingWaarde2Numeriek());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of GsAanvvoorwaardenMedbewEnTekstblok (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GsAanvvoorwaardenMedbewEnTekstblok Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GsAanvvoorwaardenMedbewEnTekstblokPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GsAanvvoorwaardenMedbewEnTekstblokPeer();
        }
    ...
    {
        return (string) $this->exportTo(GsAanvvoorwaardenMedbewEnTekstblokPeer::DEFAULT_STRING_FORMAT);
    }
