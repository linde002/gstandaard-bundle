...
abstract class BaseGsVoorschrijfprIdentificerendeVelden extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PharmaIntelligence\\GstandaardBundle\\Model\\GsVoorschrijfprIdentificerendeVeldenPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GsVoorschrijfprIdentificerendeVeldenPeer
     */
    ...
    /**
     * The value for the identificerend_kenmerk field.
     * @var        string
     */
    protected $identificerend_kenmerk;
    ...
    /**
     * Get the [identificerend_kenmerk] column value.
     *
     * @return string
     */
    public function getIdentificerendKenmerk()
    {

        return $this->identificerend_kenmerk;
    }
     ...
     * @return GsVoorschrijfprIdentificerendeVelden The current object (for fluent API support)
     */
    public function setBestandnummer($v)
    {
        ...
        if ($this->bestandnummer !== $v) {
            ...
            $this->modifiedColumns[] = GsVoorschrijfprIdentificerendeVeldenPeer::BESTANDNUMMER;
        }
    ...
    public function setMutatiekode($v)
    {
        ...
        if ($this->mutatiekode !== $v) {
            $this->mutatiekode = $v;
            $this->modifiedColumns[] = GsVoorschrijfprIdentificerendeVeldenPeer::MUTATIEKODE;
        }
    ...
    public function setPrkcode($v)
    {
        ...
        if ($this->prkcode !== $v) {
            $this->prkcode = $v;
            $this->modifiedColumns[] = GsVoorschrijfprIdentificerendeVeldenPeer::PRKCODE;
        }
    ...
    /**
     * Set the value of [identificerend_kenmerk] column.
     *
     * @param  string $v new value
     * @return GsVoorschrijfprIdentificerendeVelden The current object (for fluent API support)
     */
    public function setIdentificerendKenmerk($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->identificerend_kenmerk !== $v) {
            $this->identificerend_kenmerk = $v;
            $this->modifiedColumns[] = GsVoorschrijfprIdentificerendeVeldenPeer::IDENTIFICEREND_KENMERK;
        }


        return $this;
    } // setIdentificerendKenmerk()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->identificerend_kenmerk = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = GsVoorschrijfprIdentificerendeVeldenPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GsVoorschrijfprIdentificerendeVelden object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GsVoorschrijfprIdentificerendeVeldenPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GsVoorschrijfprIdentificerendeVeldenQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GsVoorschrijfprIdentificerendeVeldenPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GsVoorschrijfprIdentificerendeVeldenPeer::BESTANDNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`bestandnummer`';
        }
        if ($this->isColumnModified(GsVoorschrijfprIdentificerendeVeldenPeer::MUTATIEKODE)) {
            $modifiedColumns[':p' . $index++]  = '`mutatiekode`';
        }
        if ($this->isColumnModified(GsVoorschrijfprIdentificerendeVeldenPeer::PRKCODE)) {
            $modifiedColumns[':p' . $index++]  = '`prkcode`';
        }
        if ($this->isColumnModified(GsVoorschrijfprIdentificerendeVeldenPeer::IDENTIFICEREND_KENMERK)) {
            $modifiedColumns[':p' . $index++]  = '`identificerend_kenmerk`';
        }

        $sql = sprintf(
            'INSERT INTO `gs_voorschrijfpr_identificerende_velden` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`prkcode`':
                        ...
                        break;
                    case '`identificerend_kenmerk`':
                        $stmt->bindValue($identifier, $this->identificerend_kenmerk, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GsVoorschrijfprIdentificerendeVeldenPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GsVoorschrijfprIdentificerendeVeldenPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getIdentificerendKenmerk();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['GsVoorschrijfprIdentificerendeVelden'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GsVoorschrijfprIdentificerendeVelden'][serialize($this->getPrimaryKey())] = true;
        $keys = GsVoorschrijfprIdentificerendeVeldenPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBestandnummer(),
            $keys[1] => $this->getMutatiekode(),
            $keys[2] => $this->getPrkcode(),
            $keys[3] => $this->getIdentificerendKenmerk(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setIdentificerendKenmerk($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setIdentificerendKenmerk($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GsVoorschrijfprIdentificerendeVeldenPeer::BESTANDNUMMER)) $criteria->add(GsVoorschrijfprIdentificerendeVeldenPeer::BESTANDNUMMER, $this->bestandnummer);
        if ($this->isColumnModified(GsVoorschrijfprIdentificerendeVeldenPeer::MUTATIEKODE)) $criteria->add(GsVoorschrijfprIdentificerendeVeldenPeer::MUTATIEKODE, $this->mutatiekode);
        if ($this->isColumnModified(GsVoorschrijfprIdentificerendeVeldenPeer::PRKCODE)) $criteria->add(GsVoorschrijfprIdentificerendeVeldenPeer::PRKCODE, $this->prkcode);
        if ($this->isColumnModified(GsVoorschrijfprIdentificerendeVeldenPeer::IDENTIFICEREND_KENMERK)) $criteria->add(GsVoorschrijfprIdentificerendeVeldenPeer::IDENTIFICEREND_KENMERK, $this->identificerend_kenmerk);
    ...
    {
        $criteria = new Criteria(GsVoorschrijfprIdentificerendeVeldenPeer::DATABASE_NAME);
        $criteria->add(GsVoorschrijfprIdentificerendeVeldenPeer::PRKCODE, $this->prkcode);
        $criteria->add(GsVoorschrijfprIdentificerendeVeldenPeer::IDENTIFICEREND_KENMERK, $this->identificerend_kenmerk);
    ...
    public function getPrimaryKey()
    {
        ...
        $pks[1] = $this->getIdentificerendKenmerk();
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setIdentificerendKenmerk($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getPrkcode()) && (null === $this->getIdentificerendKenmerk());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of GsVoorschrijfprIdentificerendeVelden (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIdentificerendKenmerk($this->getIdentificerendKenmerk());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GsVoorschrijfprIdentificerendeVelden Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GsVoorschrijfprIdentificerendeVeldenPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GsVoorschrijfprIdentificerendeVeldenPeer();
        }
    ...
    public function setGsVoorschrijfprGeneesmiddelIdentific(GsVoorschrijfprGeneesmiddelIdentific $v = null)
    {
        ...
        if ($v !== null) {
            $v->addGsVoorschrijfprIdentificerendeVelden($this);
        }
    ...
    public function getGsVoorschrijfprGeneesmiddelIdentific(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aGsVoorschrijfprGeneesmiddelIdentific === null && ($this->prkcode !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGsVoorschrijfprGeneesmiddelIdentific->addGsVoorschrijfprIdentificerendeVeldens($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->prkcode = null;
        $this->identificerend_kenmerk = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(GsVoorschrijfprIdentificerendeVeldenPeer::DEFAULT_STRING_FORMAT);
    }
