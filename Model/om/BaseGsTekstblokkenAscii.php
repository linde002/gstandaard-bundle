...
abstract class BaseGsTekstblokkenAscii extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PharmaIntelligence\\GstandaardBundle\\Model\\GsTekstblokkenAsciiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GsTekstblokkenAsciiPeer
     */
     ...
     * @return GsTekstblokkenAscii The current object (for fluent API support)
     */
    public function setBestandnummer($v)
    {
        ...
        if ($this->bestandnummer !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::BESTANDNUMMER;
        }
    ...
    public function setMutatiekode($v)
    {
        ...
        if ($this->mutatiekode !== $v) {
            $this->mutatiekode = $v;
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::MUTATIEKODE;
        }
    ...
    public function setThesaurusVerwijzingTekstmodule($v)
    {
        ...
        if ($this->thesaurus_verwijzing_tekstmodule !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::THESAURUS_VERWIJZING_TEKSTMODULE;
        }
    ...
    public function setTekstmodule($v)
    {
        ...
        if ($this->tekstmodule !== $v) {
            $this->tekstmodule = $v;
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::TEKSTMODULE;
        }
    ...
    public function setThesaurusVerwijzingTekstsoort($v)
    {
        ...
        if ($this->thesaurus_verwijzing_tekstsoort !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::THESAURUS_VERWIJZING_TEKSTSOORT;
        }
    ...
    public function setTekstsoort($v)
    {
        ...
        if ($this->tekstsoort !== $v) {
            $this->tekstsoort = $v;
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::TEKSTSOORT;
        }
    ...
    public function setTekstNivoKode($v)
    {
        ...
        if ($this->tekst_nivo_kode !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::TEKST_NIVO_KODE;
        }
    ...
    public function setTekstbloknummer($v)
    {
        ...
        if ($this->tekstbloknummer !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::TEKSTBLOKNUMMER;
        }
    ...
    public function setTekstregelnummer($v)
    {
        ...
        if ($this->tekstregelnummer !== $v) {
            ...
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::TEKSTREGELNUMMER;
        }
    ...
    public function setTekst($v)
    {
        ...
        if ($this->tekst !== $v) {
            $this->tekst = $v;
            $this->modifiedColumns[] = GsTekstblokkenAsciiPeer::TEKST;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = GsTekstblokkenAsciiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GsTekstblokkenAscii object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GsTekstblokkenAsciiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GsTekstblokkenAsciiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GsTekstblokkenAsciiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::BESTANDNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`bestandnummer`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::MUTATIEKODE)) {
            $modifiedColumns[':p' . $index++]  = '`mutatiekode`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::THESAURUS_VERWIJZING_TEKSTMODULE)) {
            $modifiedColumns[':p' . $index++]  = '`thesaurus_verwijzing_tekstmodule`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKSTMODULE)) {
            $modifiedColumns[':p' . $index++]  = '`tekstmodule`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::THESAURUS_VERWIJZING_TEKSTSOORT)) {
            $modifiedColumns[':p' . $index++]  = '`thesaurus_verwijzing_tekstsoort`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKSTSOORT)) {
            $modifiedColumns[':p' . $index++]  = '`tekstsoort`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKST_NIVO_KODE)) {
            $modifiedColumns[':p' . $index++]  = '`tekst_nivo_kode`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKSTBLOKNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`tekstbloknummer`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKSTREGELNUMMER)) {
            $modifiedColumns[':p' . $index++]  = '`tekstregelnummer`';
        }
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKST)) {
            $modifiedColumns[':p' . $index++]  = '`tekst`';
        }

        $sql = sprintf(
            'INSERT INTO `gs_tekstblokken_ascii` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GsTekstblokkenAsciiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GsTekstblokkenAsciiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GsTekstblokkenAscii'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GsTekstblokkenAscii'][serialize($this->getPrimaryKey())] = true;
        $keys = GsTekstblokkenAsciiPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::BESTANDNUMMER)) $criteria->add(GsTekstblokkenAsciiPeer::BESTANDNUMMER, $this->bestandnummer);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::MUTATIEKODE)) $criteria->add(GsTekstblokkenAsciiPeer::MUTATIEKODE, $this->mutatiekode);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::THESAURUS_VERWIJZING_TEKSTMODULE)) $criteria->add(GsTekstblokkenAsciiPeer::THESAURUS_VERWIJZING_TEKSTMODULE, $this->thesaurus_verwijzing_tekstmodule);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKSTMODULE)) $criteria->add(GsTekstblokkenAsciiPeer::TEKSTMODULE, $this->tekstmodule);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::THESAURUS_VERWIJZING_TEKSTSOORT)) $criteria->add(GsTekstblokkenAsciiPeer::THESAURUS_VERWIJZING_TEKSTSOORT, $this->thesaurus_verwijzing_tekstsoort);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKSTSOORT)) $criteria->add(GsTekstblokkenAsciiPeer::TEKSTSOORT, $this->tekstsoort);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKST_NIVO_KODE)) $criteria->add(GsTekstblokkenAsciiPeer::TEKST_NIVO_KODE, $this->tekst_nivo_kode);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKSTBLOKNUMMER)) $criteria->add(GsTekstblokkenAsciiPeer::TEKSTBLOKNUMMER, $this->tekstbloknummer);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKSTREGELNUMMER)) $criteria->add(GsTekstblokkenAsciiPeer::TEKSTREGELNUMMER, $this->tekstregelnummer);
        if ($this->isColumnModified(GsTekstblokkenAsciiPeer::TEKST)) $criteria->add(GsTekstblokkenAsciiPeer::TEKST, $this->tekst);
    ...
    {
        $criteria = new Criteria(GsTekstblokkenAsciiPeer::DATABASE_NAME);
        $criteria->add(GsTekstblokkenAsciiPeer::TEKSTMODULE, $this->tekstmodule);
        $criteria->add(GsTekstblokkenAsciiPeer::TEKSTSOORT, $this->tekstsoort);
        $criteria->add(GsTekstblokkenAsciiPeer::TEKST_NIVO_KODE, $this->tekst_nivo_kode);
        $criteria->add(GsTekstblokkenAsciiPeer::TEKSTBLOKNUMMER, $this->tekstbloknummer);
        $criteria->add(GsTekstblokkenAsciiPeer::TEKSTREGELNUMMER, $this->tekstregelnummer);
     ...
     * objects.
     *
     * @param object $copyObj An object of GsTekstblokkenAscii (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GsTekstblokkenAscii Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GsTekstblokkenAsciiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GsTekstblokkenAsciiPeer();
        }
    ...
    {
        return (string) $this->exportTo(GsTekstblokkenAsciiPeer::DEFAULT_STRING_FORMAT);
    }
